 ...
 */
class getTentativePinFailedRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TentativePinFailedRepository' shared autowired service.
     *
     * @return \App\Repository\TentativePinFailedRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TentativePinFailedRepository.php';

        return $container->privates['App\\Repository\\TentativePinFailedRepository'] = new \App\Repository\TentativePinFailedRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
