 ...
 */
class getTentativeMdpFailedRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TentativeMdpFailedRepository' shared autowired service.
     *
     * @return \App\Repository\TentativeMdpFailedRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TentativeMdpFailedRepository.php';

        return $container->privates['App\\Repository\\TentativeMdpFailedRepository'] = new \App\Repository\TentativeMdpFailedRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
